...
- **Run:** `2026-07-12_20-00-20`
- **Marker:** `E2E-SR-RH-1783897220685`
- **RequestId:** `11ea9154-2200-46dc-a36d-6970346d3590`
- **Atores:** colaborador/RH (`leonardo.mendes@liotecnica.com.br` — mesmo usuário local com `rh_requests.manage`)
- **Pasta:** `e2e/evidence/solicitacoes-rh-uat/2026-07-12_20-00-20`
- **Erro:** [2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed

Locator:  getByText(/Resposta do RH/i).first()
Expected: visible
Received: hidden
Timeout:  15000ms
...
[2m  - waiting for getByText(/Resposta do RH/i).first()[22m
[2m    33 × locator resolved to <strong>Nova resposta do RH — benefício</strong>[22m
...
Gerado em: 2026-07-12T23:00:43.447Z
