...
window.ROADMAP_DATA = {
  ...
  gestorChecklist: [
    ...
    { id: "G-IN-01", pillar: "Intranet", item: "Painel de administração de comunicados", status: "integrated", spec: "04-specs-intranet.html#spec-admin-comunicados", backlog: "02-backlog.html#US-INTRA-001" },
    { id: "G-IN-02", pillar: "Intranet", item: "Comunicação", status: "integrated", spec: "04-specs-intranet.html#spec-comunicacao", backlog: "02-backlog.html#US-INTRA-002" },
    { id: "G-IN-03", pillar: "Intranet", item: "Aniversariantes", status: "integrated", spec: "04-specs-intranet.html#spec-aniversariantes", backlog: "02-backlog.html#US-INTRA-003" },
    { id: "G-IN-04", pillar: "Intranet", item: "Feed de notícias", status: "integrated", spec: "04-specs-intranet.html#spec-noticias", backlog: "02-backlog.html#US-INTRA-004" },
    { id: "G-IN-05", pillar: "Intranet", item: "Como me sinto", status: "integrated", spec: "04-specs-intranet.html#spec-mood", backlog: "02-backlog.html#US-INTRA-005" },
    { id: "G-IN-06", pillar: "Intranet", item: "Envio de Feedback", status: "integrated", spec: "04-specs-intranet.html#spec-feedback", backlog: "02-backlog.html#US-INTRA-006" },
  ...
  stories: [
    ...
    { id: "US-INTRA-001", epic: "EPIC-INTRA", feature: "Admin Comunicados", title: "CRUD e publicação de comunicados", phase: "F1", status: "integrated", priority: "Alta", route: "/comunicados/oficiais/novo", file: "src/components/pages/ComunicadoEditorPage.tsx" },
    { id: "US-INTRA-002", epic: "EPIC-INTRA", feature: "Comunicação", title: "Unificar canais de comunicação interna", phase: "F1", status: "integrated", priority: "Média", route: "/comunicados", file: "src/components/comunicados/" },
    { id: "US-INTRA-003", epic: "EPIC-INTRA", feature: "Aniversariantes", title: "Listar aniversariantes e parabenizar", phase: "F1", status: "integrated", priority: "Média", route: "/pessoas/aniversariantes", file: "src/components/pessoas/BirthdaysPage.tsx" },
    { id: "US-INTRA-004", epic: "EPIC-INTRA", feature: "Feed Notícias", title: "Feed de notícias unificado (sem cards estáticos)", phase: "F3", status: "integrated", priority: "Média", route: "/noticias", file: "src/components/pages/NoticiasHubPage.tsx" },
    { id: "US-INTRA-005", epic: "EPIC-INTRA", feature: "Como me sinto", title: "Registrar humor diário + dashboard RH", phase: "F1", status: "integrated", priority: "Média", route: "/servicos/clima", file: "src/components/pages/F3Pages.tsx" },
    { id: "US-INTRA-006", epic: "EPIC-INTRA", feature: "Feedback", title: "Enviar feedback e triagem RH/gestor", phase: "F3", status: "integrated", priority: "Média", route: "/feedback", file: "src/components/pages/F3Pages.tsx" },
