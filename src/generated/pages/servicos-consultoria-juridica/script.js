(function () {
      ...
      const catIcons = {
        ...
        "societario": "fa-building-columns",
        "regulatorio": "fa-landmark"
};
      const items = [
        {
                "title": "Agendar consulta",
                "desc": "Marque horário com advogado interno para dúvida específica da sua área.",
                "cat": "contratos",
                "provider": "Jurídico",
                "status": "disponivel",
                "featured": true
        ...
        {
                "title": "Parecer expresso",
                "desc": "Resposta por e-mail em até 2 dias úteis para questões objetivas.",
                "cat": "trabalhista",
                "provider": "Jurídico",
                "status": "disponivel",
                "featured": false
        },
        {
                ...
                "desc": "Dúvidas sobre jornada, férias, desligamento e relações de trabalho.",
                "cat": "trabalhista",
                "provider": "Jurídico",
                "status": "disponivel",
                "featured": false
        ...
        {
                "title": "Questões societárias",
                "desc": "Assembleias, atas, alterações contratuais e governança corporativa.",
                "cat": "societario",
                "provider": "Jurídico",
                "status": "sob_analise",
                "featured": false
        ...
        {
                "title": "Regulatório e licenças",
                "desc": "Orientação sobre ANVISA, IBAMA, ANATEL e órgãos do setor.",
                "cat": "regulatorio",
                "provider": "Jurídico",
                "status": "disponivel",
                "featured": false
        ...
        {
                "title": "Base de pareceres",
                "desc": "Consulte pareceres anteriores anonimizados por tema (acesso restrito).",
                "cat": "contratos",
                "provider": "Jurídico",
                "status": "disponivel",
                "featured": false
      ...
      const root = document.getElementById("jur-consulta-root");
      const countEl = document.getElementById("jur-consulta-count");
      const filters = document.getElementById("jur-consulta-filters");
      if (!root) return;
      root.innerHTML = items.map(renderItem).join("");

      function applyFilter(filter) {
        const query = (document.getElementById("jur-consulta-search")?.value || "").trim().toLowerCase();
        let visible = 0;
      ...
      const searchInput = document.getElementById("jur-consulta-search");
      if (searchInput) {
