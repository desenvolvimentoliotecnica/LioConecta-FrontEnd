...
import content_comunicados_arquivo from "./pages/comunicados-arquivo/content.html?raw";
import styles_comunicados_arquivo from "./pages/comunicados-arquivo/styles.css?inline";
import content_comunicados_departamentais from "./pages/comunicados-departamentais/content.html?raw";
import styles_comunicados_departamentais from "./pages/comunicados-departamentais/styles.css?inline";
import content_comunicados_oficiais from "./pages/comunicados-oficiais/content.html?raw";
import styles_comunicados_oficiais from "./pages/comunicados-oficiais/styles.css?inline";
import content_comunicados_urgentes from "./pages/comunicados-urgentes/content.html?raw";
import styles_comunicados_urgentes from "./pages/comunicados-urgentes/styles.css?inline";
import content_documentos_biblioteca from "./pages/documentos-biblioteca/content.html?raw";
import styles_documentos_biblioteca from "./pages/documentos-biblioteca/styles.css?inline";
import content_documentos_formularios from "./pages/documentos-formularios/content.html?raw";
import styles_documentos_formularios from "./pages/documentos-formularios/styles.css?inline";
import content_documentos_manuais from "./pages/documentos-manuais/content.html?raw";
import styles_documentos_manuais from "./pages/documentos-manuais/styles.css?inline";
import content_documentos_modelos from "./pages/documentos-modelos/content.html?raw";
import styles_documentos_modelos from "./pages/documentos-modelos/styles.css?inline";
import content_documentos_politicas from "./pages/documentos-politicas/content.html?raw";
import styles_documentos_politicas from "./pages/documentos-politicas/styles.css?inline";
import content_feed from "./pages/feed/content.html?raw";
import styles_feed from "./pages/feed/styles.css?inline";
import content_grupos_criar_grupo from "./pages/grupos-criar-grupo/content.html?raw";
import styles_grupos_criar_grupo from "./pages/grupos-criar-grupo/styles.css?inline";
import content_grupos_explorar from "./pages/grupos-explorar/content.html?raw";
import styles_grupos_explorar from "./pages/grupos-explorar/styles.css?inline";
import content_grupos_meus_grupos from "./pages/grupos-meus-grupos/content.html?raw";
import styles_grupos_meus_grupos from "./pages/grupos-meus-grupos/styles.css?inline";
import content_pessoas_aniversariantes from "./pages/pessoas-aniversariantes/content.html?raw";
import styles_pessoas_aniversariantes from "./pages/pessoas-aniversariantes/styles.css?inline";
import content_pessoas_diretorio from "./pages/pessoas-diretorio/content.html?raw";
import styles_pessoas_diretorio from "./pages/pessoas-diretorio/styles.css?inline";
import content_pessoas_novos_colaboradores from "./pages/pessoas-novos-colaboradores/content.html?raw";
import styles_pessoas_novos_colaboradores from "./pages/pessoas-novos-colaboradores/styles.css?inline";
import content_pessoas_organograma from "./pages/pessoas-organograma/content.html?raw";
...
import styles_servicos_estacionamento from "./pages/servicos-estacionamento/styles.css?inline";
...
import content_servicos_gestao_residuos from "./pages/servicos-gestao-residuos/content.html?raw";
...
import styles_servicos_refeitorio from "./pages/servicos-refeitorio/styles.css?inline";
...
export const pageAssets: Record<string, { content: string; styles: string }> = {
  ...
  "comunicados-departamentais": { content: content_comunicados_departamentais, styles: styles_comunicados_departamentais },
  "comunicados-oficiais": { content: content_comunicados_oficiais, styles: styles_comunicados_oficiais },
  "comunicados-urgentes": { content: content_comunicados_urgentes, styles: styles_comunicados_urgentes },
  "documentos-biblioteca": { content: content_documentos_biblioteca, styles: styles_documentos_biblioteca },
  "documentos-formularios": { content: content_documentos_formularios, styles: styles_documentos_formularios },
  "documentos-manuais": { content: content_documentos_manuais, styles: styles_documentos_manuais },
  "documentos-modelos": { content: content_documentos_modelos, styles: styles_documentos_modelos },
  "documentos-politicas": { content: content_documentos_politicas, styles: styles_documentos_politicas },
  "feed": { content: content_feed, styles: styles_feed },
  "grupos-criar-grupo": { content: content_grupos_criar_grupo, styles: styles_grupos_criar_grupo },
  "grupos-explorar": { content: content_grupos_explorar, styles: styles_grupos_explorar },
  "grupos-meus-grupos": { content: content_grupos_meus_grupos, styles: styles_grupos_meus_grupos },
  "pessoas-aniversariantes": { content: content_pessoas_aniversariantes, styles: styles_pessoas_aniversariantes },
  "pessoas-diretorio": { content: content_pessoas_diretorio, styles: styles_pessoas_diretorio },
