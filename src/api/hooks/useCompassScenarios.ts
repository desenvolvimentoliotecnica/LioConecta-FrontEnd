...
const MOCK_ROWS: Record<string, CompassScenarioRowsPageDto> = {
  "volume-toneladas": {
    ...
    items: [
      { sku: "SKU_120070420", skuDescription: "PRODUTO EXEMPLO A", cliente: "PENNACCHI", ung: "UN_7", entity: "Total_CC", amount: 12540.5 },
      { sku: "SKU_120080883", skuDescription: "PRODUTO EXEMPLO B", cliente: "BOMBONZAO", ung: "UN_7", entity: "Total_CC", amount: 8320.2 },
    ],
    page: 1,
    pageSize: 25,
    totalCount: 11451,
  ...
  "volume-qtde-vendas": {
    ...
    filters: MOCK_SCENARIOS.filters,
    items: [
      { sku: "SKU_120070420", skuDescription: "PRODUTO EXEMPLO A", cliente: "PENNACCHI", ung: "UN_7", entity: "Global_CC", amount: 4200 },
    ],
    page: 1,
    pageSize: 25,
    totalCount: 11451,
