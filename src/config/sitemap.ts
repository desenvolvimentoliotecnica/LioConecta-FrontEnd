  ...
  return [
      ...
      subsections: [
        {
          ...
          items: [
            ...
            ...servicosLinks.slice(0, 9).map((item) => fromNav(item)),
          ],
        },
        {
          heading: servicosHeadings[1].label,
          icon: servicosHeadings[1].icon,
          items: servicosLinks.slice(9).map((item) => fromNav(item)),
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        entry("Minhas Dúvidas", "/unilio/minhas-duvidas", "Caixa de entrada do aluno com dúvidas enviadas e respostas."),
        ...
        entry("Dúvidas recebidas", "/unilio/instrutor/duvidas", "Caixa postal do instrutor com dúvidas dos alunos."),
