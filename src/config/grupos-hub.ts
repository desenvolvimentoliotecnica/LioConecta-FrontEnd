...
export const GRUPOS_SECTIONS: HubSection[] = [
  ...
  },
  {
    ...
    description: "Descubra comunidades por tema, área ou interesse.",
    icon: "fa-compass",
    mod: "explorar",
  ...
  },
  {
    ...
    description: "Espaços abertos de colaboração entre áreas — em breve.",
    icon: "fa-globe",
    mod: "comunidades",
    count: "Em breve",
    disabled: true,
  ...
  {
    id: "criar",
    label: gruposLinks[3].label,
    path: gruposLinks[3].path,
